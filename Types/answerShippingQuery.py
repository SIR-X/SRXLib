...
class answerShippingQuery(TelegramType):
    """
    ...
    Args:
        ...
        shipping_options (list["Types.ShippingOption"]): Required if ok is True. A JSON-serialized array of available shipping options..
