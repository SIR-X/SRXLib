...
class Message(TelegramType):
    ...
    Args:
        ...
        _from ("Types.User"): Optional. Sender of the message; empty for messages sent to channels. For backward compatibility, the field contains a fake sender user in non-channel chats, if the message was sent on behalf of a chat..
        ...
        chat ("Types.Chat"): Conversation the message belongs to.

        forward_from ("Types.User"): Optional. For forwarded messages, sender of the original message.

        forward_from_chat ("Types.Chat"): Optional. For messages forwarded from channels or from anonymous administrators, information about the original sender chat.
        ...
        reply_to_message ("Types.Message"): Optional. For replies, the original message. Note that the Message object in this field will not contain further reply_to_message fields even if it itself is a reply..
        ...
        photo (list["Types.PhotoSize"]): Optional. Message is a photo, available sizes of the photo.
        ...
        pinned_message ("Types.Message"): Optional. Specified message was pinned. Note that the Message object in this field will not contain further reply_to_message fields even if it is itself a reply..
        ...
        user_shared ("Types.UserShared"): Optional. Service message: a user was shared with the bot.
        ...
        write_access_allowed ("Types.WriteAccessAllowed"): Optional. Service message: the user allowed the bot added to the attachment menu to write messages.
